...
export declare module Readers {
  export abstract class BarcodeReader {
    ...
    protected _fillCounters(
      offset?: number,
      end?: number,
      isWhite?: boolean
    ): number[];

    protected _toCounters(
      start: number,
      counters: Uint16Array | Array<number>
    ): number[] | Uint16Array;
  }
  ...
  export class TwoOfFiveReader extends BarcodeReader {
    ...
    protected _verifyTrailingWhitespace(
      endInfo: BarcodeInfo
    ...
    protected _decodePayload(
      counters: ReadonlyArray<number>,
      result: Array<string>,
      decodedCodes: Array<BarcodeInfo | BarcodePosition>
    ): BarcodeInfo | null;
  }
  ...
  export class NewCodabarReader extends BarcodeReader {
    ...
    decode(
      row?: Array<number>,
      start?: BarcodePosition | number | null
    ): Barcode | null;
    ...
    protected _thresholdResultPattern(
  ...
  export class EANReader extends BarcodeReader {
    ...
    protected _decodePayload(
      inCode: BarcodePosition,
      result: Array<number>,
      decodedCodes: Array<BarcodePosition>
    ): BarcodeInfo | null;
  ...
  export class I2of5Reader extends BarcodeReader {
    ...
    protected _decodePair(
      counterPair: Array<Array<number>>
    ): Array<BarcodeInfo> | null;
...
export interface MediaTrackConstraintsWithDeprecated
